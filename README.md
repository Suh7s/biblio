...
The shared Postman collection includes the integrated Books, Borrowing, Admin, and AI requests, plus the Authentication contracts from `architecture.md`. Authentication endpoints still require Developer 1’s module; protected routes use the shared JWT middleware.
